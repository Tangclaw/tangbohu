...
import { BookOpen, Home, Zap, LogOut, Shield, Trophy, LogIn, UserPlus, Key, Search, Code2, Coins } from 'lucide-react'
...
export default function Navbar() {
  ...
  const navItems = [
    ...
    { icon: BookOpen, label: '学术', href: '/academic', activeClass: 'font-bold text-slate-900 bg-slate-100 shadow-sm shadow-slate-950/10', hoverClass: 'hover:bg-slate-100 hover:text-slate-900' },
